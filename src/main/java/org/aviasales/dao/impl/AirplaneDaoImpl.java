...
public class AirplaneDaoImpl extends AbstractDao<Airplane> implements AirplaneDao {
    ...
    public Airplane create(Airplane airplane) {
        ...
        String sql = "INSERT INTO airplane (plane_number, airline_id, number_of_seats) VALUES(?,?,?);";
    ...
    public Airplane findById(Long id) {
        try {
            return getJdbcTemplate().queryForObject("SELECT * FROM airplane WHERE airplane_id=?",
